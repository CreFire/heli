...
type SkillSkillBullet struct {
    Id int32
}

const TypeId_SkillSkillBullet = 1629082198

func (*SkillSkillBullet) GetTypeId() int32 {
    return 1629082198
}

func NewSkillSkillBullet(_buf map[string]interface{}) (_v *SkillSkillBullet, err error) {
    _v = &SkillSkillBullet{}

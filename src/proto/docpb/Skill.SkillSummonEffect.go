...
type SkillSkillSummonEffect struct {
    Id int32
}

const TypeId_SkillSkillSummonEffect = 1687689254

func (*SkillSkillSummonEffect) GetTypeId() int32 {
    return 1687689254
}

func NewSkillSkillSummonEffect(_buf map[string]interface{}) (_v *SkillSkillSummonEffect, err error) {
    _v = &SkillSkillSummonEffect{}

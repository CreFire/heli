...
type SkillSkillBuffEffect struct {
    Id int32
}

const TypeId_SkillSkillBuffEffect = -591409384

func (*SkillSkillBuffEffect) GetTypeId() int32 {
    return -591409384
}

func NewSkillSkillBuffEffect(_buf map[string]interface{}) (_v *SkillSkillBuffEffect, err error) {
    _v = &SkillSkillBuffEffect{}

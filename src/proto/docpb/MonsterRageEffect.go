...
type MonsterRageEffect struct {
    Id int32
}

const TypeId_MonsterRageEffect = 570121880

func (*MonsterRageEffect) GetTypeId() int32 {
    return 570121880
}

func NewMonsterRageEffect(_buf map[string]interface{}) (_v *MonsterRageEffect, err error) {
    _v = &MonsterRageEffect{}

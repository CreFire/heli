...
type MonsterShape struct {
    Id int32
}

const TypeId_MonsterShape = 705512455

func (*MonsterShape) GetTypeId() int32 {
    return 705512455
}

func NewMonsterShape(_buf map[string]interface{}) (_v *MonsterShape, err error) {
    _v = &MonsterShape{}

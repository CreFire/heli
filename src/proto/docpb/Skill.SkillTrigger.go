...
type SkillSkillTrigger struct {
    Id int32
}

const TypeId_SkillSkillTrigger = 1963299556

func (*SkillSkillTrigger) GetTypeId() int32 {
    return 1963299556
}

func NewSkillSkillTrigger(_buf map[string]interface{}) (_v *SkillSkillTrigger, err error) {
    _v = &SkillSkillTrigger{}

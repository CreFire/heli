...
type SkillSkillTriggerCondition struct {
    Id int32
}

const TypeId_SkillSkillTriggerCondition = 413334167

func (*SkillSkillTriggerCondition) GetTypeId() int32 {
    return 413334167
}

func NewSkillSkillTriggerCondition(_buf map[string]interface{}) (_v *SkillSkillTriggerCondition, err error) {
    _v = &SkillSkillTriggerCondition{}

...
type SkillSkillDamageEffect struct {
    Id int32
}

const TypeId_SkillSkillDamageEffect = 1090175028

func (*SkillSkillDamageEffect) GetTypeId() int32 {
    return 1090175028
}

func NewSkillSkillDamageEffect(_buf map[string]interface{}) (_v *SkillSkillDamageEffect, err error) {
    _v = &SkillSkillDamageEffect{}

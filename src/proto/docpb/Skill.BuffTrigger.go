...
type SkillBuffTrigger struct {
    Id int32
}

const TypeId_SkillBuffTrigger = 945529224

func (*SkillBuffTrigger) GetTypeId() int32 {
    return 945529224
}

func NewSkillBuffTrigger(_buf map[string]interface{}) (_v *SkillBuffTrigger, err error) {
    _v = &SkillBuffTrigger{}
